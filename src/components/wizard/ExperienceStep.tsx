          ...
          {experiences.map((exp, idx) => (
            <div key={exp.id} className="p-5 border border-slate-200 dark:border-slate-800 rounded-2xl bg-slate-50/50 dark:bg-slate-900/50 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                <div>
                  <label className="block text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-tighter mb-1">Location</label>
                  <input
                    type="text"
                    value={exp.location || ""}
                ...
                <div>
                  <label className="block text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-tighter mb-1">Start Date</label>
                  <input
                    type="text"
                    value={exp.startDate || ""}
                ...
                <div>
                  <label className="block text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-tighter mb-1">End Date</label>
                  <input
                    type="text"
                    disabled={exp.isCurrentJob}
                    value={exp.endDate || ""}
                    onChange={(e) => handleChange(exp.id, "endDate", e.target.value)}
                    className="w-full px-3 py-2 border border-slate-200 dark:border-slate-800 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 outline-none bg-white dark:bg-slate-900 dark:text-slate-100 disabled:opacity-50"
                    placeholder="2024-01"
                  />
                </div>
              </div>
